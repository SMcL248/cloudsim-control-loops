 ...
 * dynamically.
 */
public class ManualControllerVM {
	public static ControlBroker broker;
    ...
    // MIPS tiers for VMs. When creating VMs, a MIPS value will be randomly selected from these tiers.
    private static final int[] MIPS_TIERS = {250, 500, 1000, 2000};
    private static final long VM_SEED = 42L;

	private static List<Vm> createVM(int userId, int vms, int idShift) {
		//Creates a container to store VMs. This list is passed to the broker later
		LinkedList<Vm> list = new LinkedList<>();

        Random rng = new Random(VM_SEED);
	...
	private static List<Cloudlet> createCloudlet(int userId, int cloudlets, int idShift){
        ...
        Random random = new Random(VM_SEED); // fixed seed
	...
	public static void main(String[] args) {
		Log.println("Starting ManualControllerVM...");
		...
		try {
			...
			broker = new ControlBroker("Broker_0", 100);
			...
			Log.println("ManualControllerVM finished!");
		}
		catch (Exception e)
		{
			e.printStackTrace();
