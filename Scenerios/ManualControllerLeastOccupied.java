 ...
 * dynamically.
 */
public class ManualControllerLeastOccupied {
	...
	public static void main(String[] args) {
		Log.println("Starting ManualControllerLeastOccupied...");
		...
		try {
			...
			broker = new ControlBroker("Broker_0", 20);
			...
			Log.println("ManualControllerLeastOccupied finished!");
		}
		catch (Exception e)
		{
			e.printStackTrace();
