...
public class Selector extends DatacenterBroker implements ActionSpace {
    ...
    private final boolean SWITCHABLE = true;
...
// -----------------------ReadSpace-------------------------------
    ...
    private void processHostFailure(SimEvent ev) {
        ...
        // If we find the host, set as failed and pause workload.
        if (targetHost != null){
            ...
            if (targetHost instanceof Host) {
                ...
                Log.printlnConcat(getNow(), ": [Selector] Host #", targetHost.getId(),
                    " is not a Host instance, cannot mark failed.");
            }
