...
// Strategy: Direct Scaling. Bandwidth counterpart of the direct mips/ram
// variants: looks up the tier value and attempts the scale unconditionally.
public class executor_v12 implements Executor<int[]> {
    ...
    public boolean execute(int[] actions, ActionSpace actionSpace) {
        ...
        Log.printlnConcat(actionSpace.getNow(), ": [" + tag + "] attempted bw scaling of vm ", vmId,
                " to tier ", tierIndex, " value ", newBw, ", succeeded ", succeeded);
        return true;
    }

    @Override
    public String inputSemantic() {
        return "scale vm bandwidth to given tier";
    }
