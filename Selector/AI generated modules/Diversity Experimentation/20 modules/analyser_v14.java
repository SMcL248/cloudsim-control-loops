...
// VM-level PE-allocation classifier using a tertile (equal-population thirds) rank split.
public class analyser_v14 implements Analyser<double[], LoadState[]> {
    ...
    private static final String INPUT_SEMANTIC = "vm-pe_count-number_of_processing_elements_allocated_to_vm";
    private static final String OUTPUT_SEMANTIC = "vm-load_state-tertile_rank_classification_of_pe_allocation";
    ...
    public LoadState[] analyse(double[] metrics, ReadSpace readSpace) {
        ...
        Log.printlnConcat(readSpace.getNow(), ": [analyser_v14] classified ", n,
                " VMs into tertiles by relative PE allocation");
