...
public class monitor_v4 implements Monitor<double[]> {
    ...
    public double[] observe(ReadSpace readSpace) {
        ...
        for (int i = 0; i < hosts.size(); i++) {
            ...
            result[i] = totalRam > 1e-6 ? (1.0 - (availableRam / totalRam)) : 0.0;
        }
        Log.printlnConcat(readSpace.getNow(), ": [monitor_v4] computed RAM pressure for ", hosts.size(), " hosts");
        return result;
    }

    @Override
    public String outputSemantic() {
        return "host-ram-pressure-fraction-provisioned";
    }
