...
public class executor_v27 implements Executor<int[]> {
    ...
    public boolean execute(int[] payload, ActionSpace actionSpace) {
        if (payload == null || payload.length != 1) {
            Log.printlnConcat(actionSpace.getNow(), ": [executor_v27] ",
        ...
        Log.printlnConcat(actionSpace.getNow(), ": [executor_v27] ",
                "issued requestPeAllocation vm=" + vmId + " succeeded=" + succeeded);
        return true;
    }
