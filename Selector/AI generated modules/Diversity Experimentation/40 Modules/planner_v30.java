...
public class planner_v30 implements Planner<LoadState[], int[]> {
    ...
    public int[] plan(LoadState[] diagnosis, ReadSpace readSpace) {
        ...
        Log.printlnConcat(readSpace.getNow(), ": [planner_v30] PE-Demand-Weighted Migration moving cloudlet ", cloudletId, " (pes=", mostPes, ") from VM ", fromVmId, " to VM ", toVmId, ".");
        return new int[]{cloudletId, fromVmId, toVmId};
    }

    @Override
    public String inputSemantic() {
        return "cloudlet-loadstate-pe-demand-weighted";
    }
