...
public class planner_v28 implements Planner<LoadState[], int[]> {
    ...
    public int[] plan(LoadState[] diagnosis, ReadSpace readSpace) {
        ...
        Log.printlnConcat(readSpace.getNow(), ": [planner_v28] Longest-Job Offload moving cloudlet ", cloudletId, " (remaining=", longest, ") from VM ", fromVmId, " to VM ", toVmId, ".");
        return new int[]{cloudletId, fromVmId, toVmId};
    }

    @Override
    public String inputSemantic() {
        return "cloudlet-loadstate-longest-job";
    }
