...
public class planner_v33 implements Planner<LoadState[], int[]> {
    ...
    public int[] plan(LoadState[] diagnosis, ReadSpace readSpace) {
        ...
        for (int i = 0; i < n; i++) {
            ...
            double progress = total > 0 ? 1.0 - ((double) remaining / (double) total) : 0.0;
        ...
        Log.printlnConcat(readSpace.getNow(), ": [planner_v33] Low-Progress Preferential Migration moving cloudlet ", cloudletId, " (progress=", lowestProgress, ") from VM ", fromVmId, " to VM ", toVmId, ".");
        return new int[]{cloudletId, fromVmId, toVmId};
    }

    @Override
    public String inputSemantic() {
        return "cloudlet-loadstate-low-progress";
    }
