...
public class planner_v37 implements Planner<LoadState[], int[]> {
    ...
    public int[] plan(LoadState[] diagnosis, ReadSpace readSpace) {
        ...
        if (sourceHost != null) {
            ...
            if (!vmsOnHost.isEmpty()) {
                ...
                for (HostEntity h : hosts) {
                    ...
                    if (readSpace.isHostPoweringUp(h)) continue;
                    if (readSpace.isHostPoweredDown(h)) continue;
        ...
        Log.printlnConcat(readSpace.getNow(), ": [planner_v37] Power-Stability-Aware Migration moving VM ", vmId, " to power-stable host ", targetHostId, ".");
        return new int[]{vmId, targetHostId};
    }

    @Override
    public String inputSemantic() {
        return "host-loadstate-power-stability";
    }
