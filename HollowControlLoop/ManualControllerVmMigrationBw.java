 ...
 * dynamically.
 */
public class ManualControllerVmMigrationBw {
	...
	public static void main(String[] args) {
		Log.println("Starting ManualControllerVmMigrationBw...");
		...
		try {
			...
			broker = new HollowedControl("Broker_0", 100, new Monitor4(), new Analyser4(), new Planner2(), new Executor2());
			...
			Log.println("ManualControllerVmMigrationBw finished!");
		}
		catch (Exception e)
		{
			e.printStackTrace();
