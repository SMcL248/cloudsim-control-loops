 ...
 * dynamically.
 */
public class ManualControllerVmMigrationCost {
	...
	public static void main(String[] args) {
		Log.println("Starting ManualControllerVmMigrationCost...");
		...
		try {
			...
			broker = new HollowedControl("Broker_0", 100, new Monitor5(), new Analyser6(), new Planner2(), new Executor2());
			...
			Log.println("ManualControllerVmMigrationCost finished!");
		}
		catch (Exception e)
		{
			e.printStackTrace();
