 ...
 * dynamically.
 */
public class ManualControllerVmScaleUp {
	...
	public static void main(String[] args) {
		Log.println("Starting ManualControllerVmScaleUp...");
		...
		try {
			...
			broker = new HollowedControl("Broker_0", 100, new Monitor2(), new Analyser2(), new Planner3(), new Executor3());
			...
			Log.println("ManualControllerVmScaleUp finished!");
		}
		catch (Exception e)
		{
			e.printStackTrace();
