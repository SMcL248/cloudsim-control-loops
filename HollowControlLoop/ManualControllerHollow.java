 ...
 * dynamically.
 */
public class ManualControllerHollow {
	...
	public static void main(String[] args) {
		Log.println("Starting ManualControllerHollow...");
		...
		try {
			...
			broker = new HollowedControl("Broker_0", 20, new Monitor1(), new Analyser1(), new Planner1(), new Executor1());
			...
			Log.println("ManualControllerHollow finished!");
		}
		catch (Exception e)
		{
			e.printStackTrace();
