 ...
 * dynamically.
 */
public class ManualControllerVmMigrationRam {
	...
	public static void main(String[] args) {
		Log.println("Starting ManualControllerVmMigrationRam...");
		...
		try {
			...
			broker = new HollowedControl("Broker_0", 100, new Monitor3(), new Analyser3(), new Planner2(), new Executor2());
			...
			Log.println("ManualControllerVmMigrationRam finished!");
		}
		catch (Exception e)
		{
			e.printStackTrace();
