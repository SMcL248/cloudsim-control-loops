 ...
 * dynamically.
 */
public class ManualControllerHollowVmMigration {
	...
	public static void main(String[] args) {
		Log.println("Starting ManualControllerHollowVmMigration...");
		...
		try {
			...
			broker = new HollowedControl("Broker_0", 100, new Monitor2(), new Analyser2(), new Planner2(), new Executor2());
			...
			Log.println("ManualControllerHollowVmMigration finished!");
		}
		catch (Exception e)
		{
			e.printStackTrace();
